...
function addFriend(){
    ...
    newFormFriend.innerHTML += '<div class="row mb-4"><div class="col-lg-3 col-md-2"></div><div class="col-lg-3 col-md-4 col-sm-6"><label for="validationDefault01" class="form-label">Nome</label><input type="text" class="form-control" id="validationDefault01" value="" required></div><div class="col-lg-3 col-md-4 col-sm-6"><label for="validationDefault02" class="form-label">Cognome</label><input type="text" class="form-control" id="validationDefault02" value="" required></div><div class="col-lg-3 col-md-2"></div></div><div id="phoneNumber" class="row mb-4"><div class="col-md-4 col-2"></div><div class="col-md-4 col-sm-8"><label for="validationDefault03" class="form-label">Telefono</label><div class="input-group"><span class="input-group-text" id="inputGroupPrepend3">+39</span><input type="tel" class="form-control" id="validationDefault03" aria-describedby="inputGroupPrepend3" required></div></div><div class="col-md-4 col-2"></div></div>';
